...
var Table = function (_React$Component) {
    ...
    function Table(props) {
        ...
        _this.rcTableRef = function (rcTable) {
            _this.rcTable = rcTable;
        };
        _this.renderTable = function (contextLocale) {
            ...
            var _a = _this.props,
                ...
                restProps = __rest(_a, ["style", "loading", "className", "prefixCls", "showHeader"]);
            ...
            return React.createElement(RcTable, _extends({ key: 'table' }, restProps, { ref: _this.rcTableRef, onRow: _this.onRow, components: _this.components, prefixCls: prefixCls, data: data, columns: columns, showHeader: showHeader, className: classString, expandIconColumnIndex: expandIconColumnIndex, expandIconAsCell: expandIconAsCell, emptyText: !loading && locale.emptyText }));
        };
